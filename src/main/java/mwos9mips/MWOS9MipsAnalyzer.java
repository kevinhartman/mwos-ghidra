...
public class MWOS9MipsAnalyzer extends ConstantPropagationAnalyzer {
	...
	public AddressSetView flowConstants(final Program program, Address flowStart,
		...
		Address currentCPAssumptionValue = cp_assumption_value;
		...
		var eval = new ConstantPropagationContextEvaluator(trustWriteMemOption) {
			private Address localGPAssumptionValue = currentGPAssumptionValue;
			private Address localCPAssumptionValue = currentCPAssumptionValue;
			...
			public boolean evaluateContext(VarnodeContext context, Instruction instr) {
				...
				// TODO: don't bother with CP for now. This code should be rewritten...
